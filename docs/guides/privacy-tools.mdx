...
Terms of Service; Didn't Read (ToS;DR) is an active project to fix the biggest lie on the web. The project aims to aggregate and summarise the Terms and Conditions and Privacy Policies of websites & services online.
